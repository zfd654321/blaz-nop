...
public class ApplicationServerLauncher {
	...
	private static final int DEFLOUD_PORT = 8085;
	private static final String PROJECT_NAME = "tts";
    ...
    public static void main(String[] args) throws Exception {
		...
		//加载spring配置文件
		context.setConfigLocations("classpath:spring/applicationContext.xml", "classpath:spring/spring-hessian.xml", "classpath:spring/spring-hessian-req.xml", "classpath:spring/spring-quartz.xml");
